...
For standalone installs, download the matching `lazyfind_VERSION_OS_ARCH.tar.gz`
from [GitHub Releases](https://github.com/daviddwlee84/lazyfind/releases), verify its
...
go install github.com/daviddwlee84/lazyfind@latest
```
...
python3 scripts/release.py check --project lazyfind --binary lazyfind --smoke
